...
class RetrievalDatabase:
    ...
    def __new__(cls, dimension: int, redis_host: str = "redis", redis_port: int = 6379, faiss_index_file : str = "faiss_index.bin"):
        """
    ...
    def _init_instance(self, dimension: int, redis_host: str, redis_port: int, faiss_index_file : str) -> None:
        self.redis_db = redis.Redis(host=redis_host, port=redis_port, db=3, decode_responses=True)
